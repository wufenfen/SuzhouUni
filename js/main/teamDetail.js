    ...
    initNav();
	 ...
	 if(type == 1){
	     if(id==1){
		     ...
		     current_occupation='Professor, School of Mathematical Sciences and Mathematical Center for Interdiscipline Research, Soochow University, Suzhou, Jiangsu 215006 China';
             ...
             education_BS_r1='Sept. 1984 – June 1988        BS, Soochow University';
             education_BS_r2='Major: Mathematical Education';
             education_MS_r1='Sept. 1988 – June 1991        MS, Soochow University';
             education_MS_r2='Major: Applied Mathematics';
             education_PHD_r1='Sept. 1995 – June 1998        PhD, Soochow University';
             education_PHD_r2='Major: Applied Mathematics    Supervisor: Professor Lishang Jiang';
             work_experience_h1='';
             work_experience_h2='';
             work_experience_h3='';
             work_experience_h4='';
	 ...
	 $("#Current_occupation").html('&nbsp;&nbsp;&nbsp;&nbsp;' + current_occupation);
	 $("#Research_interests").html('&nbsp;&nbsp;&nbsp;&nbsp;' + research_interests);
	 $("#Education_BS_r1").html('&nbsp;&nbsp;&nbsp;&nbsp;' + education_BS_r1);
	 $("#Education_BS_r2").html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + education_BS_r2);
	 $("#Education_MS_r1").html('&nbsp;&nbsp;&nbsp;&nbsp;' + education_MS_r1);
	 $("#Education_MS_r2").html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + education_MS_r2);
	 $("#Education_PHD_r1").html('&nbsp;&nbsp;&nbsp;&nbsp;' + education_PHD_r1);
	 $("#Education_PHD_r2").html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + education_PHD_r2);
	 $("#Work_experience_h1").html('&nbsp;&nbsp;&nbsp;&nbsp;' + work_experience_h1);
	 $("#Work_experience_h2").html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + work_experience_h2);
	 $("#Work_experience_h3").html('&nbsp;&nbsp;&nbsp;&nbsp;' + work_experience_h3);
	 $("#Work_experience_h4").html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + work_experience_h4);
	 $("#Work_experience_h5").html('&nbsp;&nbsp;&nbsp;&nbsp;' + work_experience_h5);
	 $("#Work_experience_h6").html('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + work_experience_h6);
	 $("#Publication_sp1").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp1);
	 $("#Publication_sp2").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp2);
	 $("#Publication_sp3").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp3);
	 $("#Publication_sp4").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp4);
	 $("#Publication_sp5").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp5);
	 $("#Publication_sp6").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp6);
	 $("#Publication_sp7").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp7);
	 $("#Publication_sp8").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp8);
	 $("#Publication_sp9").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp9);
	 $("#Publication_sp10").html('&nbsp;&nbsp;&nbsp;&nbsp;' + publication_sp10);
});
