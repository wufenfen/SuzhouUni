+function ($) {
	...
	Confirmation.DEFAULTS = $.extend({}, $.fn.popover.Constructor.DEFAULTS, {
		placement 		: 'right',
		title 			: '确定删除吗?',
		btnOkClass 		: 'btn btn-danger btn-raised',
		btnOkLabel 		: '删除',
		btnOkIcon 		: 'glyphicon glyphicon-ok',
		btnCancelClass 	: 'btn btn-info btn-raised',
		btnCancelLabel 	: '取消',
		...
		template 		:   '<div class="popover"><div class="arrow"></div>'
							...
							+ '<button type="button" data-apply="confirmation">Yes</button>'
							+ '<button type="button" data-dismiss="confirmation">No</button>'
							+ '</div>'
							+ '</div>'
	});
